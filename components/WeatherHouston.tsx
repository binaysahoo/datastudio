...
export default function WeatherHouston() {
    ...
    async function fetchWeather() {
      try {
        ...
        const response = await fetch(
          'https://api.open-meteo.com/v1/forecast?latitude=29.7604&longitude=-95.3698&current=temperature_2m,relative_humidity_2m,precipitation,wind_speed_10m,weather_code,us_aqi&hourly=temperature_2m,precipitation,wind_speed_10m&daily=weather_code,temperature_2m_max,temperature_2m_min&timezone=America/Chicago&temperature_unit=fahrenheit&wind_speed_unit=mph&forecast_days=8'
        )
  ...
  return (
    ...
    >
      <div className="mb-6">
        ...
        <p className="text-sm text-neutral-600 dark:text-neutral-400">Texas, USA</p>
      </div>

      {/* Current Weather */}
      <div className="flex items-center justify-between mb-6 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-neutral-800 dark:to-neutral-700 rounded-xl">
      ...
      <div className="h-48 mb-6">
        {chartData.length > 0 ? (
          ...
          <AreaChart data={chartData}>
            <defs>
              <linearGradient id="colorTempHouston" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#f59e0b" stopOpacity={0.3} />
                <stop offset="95%" stopColor="#f59e0b" stopOpacity={0} />
              </linearGradient>
              <linearGradient id="colorPrecipHouston" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#3b82f6" stopOpacity={0.3} />
                <stop offset="95%" stopColor="#3b82f6" stopOpacity={0} />
              </linearGradient>
              <linearGradient id="colorWindHouston" x1="0" y1="0" x2="0" y2="1">
            ...
            <Area
              ...
              fill={`url(#color${activeTab === 'temp' ? 'Temp' : activeTab === 'precip' ? 'Precip' : 'Wind'}Houston)`}
              strokeWidth={2}
            />
          </AreaChart>
        </ResponsiveContainer>
