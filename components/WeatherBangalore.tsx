...
export default function WeatherBangalore() {
  ...
  return (
    ...
    >
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400">Karnataka, India</p>
      </div>
        ...
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={chartData}>
            ...
            <Area
              ...
              strokeWidth={2}
              fill={`url(#color${activeTab === 'temp' ? 'Temp' : activeTab === 'precip' ? 'Precip' : 'Wind'})`}
            />
          </AreaChart>
        </ResponsiveContainer>
      </div>
